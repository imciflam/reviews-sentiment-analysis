...
def lstm():
    f = open('models/my_lstm.pickle', 'rb')
    # model = pickle.load(f)
    model = load_model(
        'C:/Users/Vitalia/Documents/GitHub/reviews-sentiment-analysis/models/model.h5', compile=False)
    ...
    testing_list.append(re.sub("[^\w]", " ",  testing).split())
